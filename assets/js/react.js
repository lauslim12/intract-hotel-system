...
const APIURL = "http://localhost/Intractive/api/logged_user";
...
class Header extends React.Component {  
  ...
  render() {
    const fullName = this.state.data.first_name + ' ' + this.state.data.last_name;
    const profilePicture = `${BASEURL}` + this.state.data.profile_pic;
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                aria-haspopup="true" aria-expanded="false">
                <img class="img-profile rounded-circle" src={profilePicture} style={imageMaxWidth}></img>
                <span class="ml-2 d-none d-lg-inline text-white small">{fullName}</span>
              </a>
