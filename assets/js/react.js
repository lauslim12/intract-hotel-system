  ...
  render() {
    return (
      <nav classNameName="navbar navbar-expand-lg navbar-light bg-light">
        <a classNameName="navbar-brand" href={`${BASEURL}`}>Navbar</a>
        ...
        <div classNameName="collapse navbar-collapse" id="navbarNavAltMarkup">
          <div classNameName="navbar-nav">
            ...
            <a classNameName="nav-item nav-link" href="#"><Clock/></a>
          </div>
        </div>
      </nav>
    )
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                <span class="ml-2 d-none d-lg-inline text-white small">{this.state.data.first_name + ' ' + this.state.data.last_name}</span>
              </a>
            <ProfileDropdown/>
            </li>
          </ul>
      ...
      <li class="nav-item">
        ...
        <div id="collapseTable" class="collapse" aria-labelledby="headingTable" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href={BASEURL + '/admin/showData'}>All Hotels</a>
